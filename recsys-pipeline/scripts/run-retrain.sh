...
#
# Usage:
#   ./run-retrain.sh [--skip-spark]
#
# Environment Variables:
#   REDIS_HOST                Redis host (default: localhost)
#   REDIS_PORT                Redis port (default: 6379)
#   RATINGS_CSV               Path to base ratings CSV (default: sampledata/ratings.csv)
#   ITEM2VEC_EMBEDDING_PATH   Item2Vec embedding file (default: sampledata/item_embedding.txt)
...
ITEM_EMB_PATH="${ITEM2VEC_EMBEDDING_PATH:-${SCRIPT_DIR}/sampledata/item_embedding.txt}"
DRY_RUN="${DRY_RUN:-0}"
