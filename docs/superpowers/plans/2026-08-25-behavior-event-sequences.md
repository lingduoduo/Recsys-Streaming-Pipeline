...
- [x] **Step 3: Write failing Scala codec tests**
...
- [x] **Step 4: Run Scala codec tests and verify RED**
...
- [x] **Step 5: Implement Avro v3 and action-aware codecs**
...
- [x] **Step 1: Write the failing journey test**
...
- [x] **Step 3: Implement the minimal journey generator**
...
- [x] **Step 3: Implement behavioral filtering**
...
- [x] **Step 4: Write failing projection and shared-contract tests**
...
- [x] **Step 6: Implement dual-write projections and sinks**
...
- [x] **Step 1: Write failing hydrator tests**
...
- [x] **Step 3: Implement the hydrator**
...
- [x] **Step 4: Wire the bean and shared schema constant**
...
- [x] **Step 3: Check contracts and diff hygiene**
...
- [x] **Step 5: Request code review and prepare PR**
